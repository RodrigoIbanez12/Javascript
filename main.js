...
const MarketingDigital = new Curso(1, 'Marketing Digital', 800);
const RedesSociales = new Curso(2, 'Redes Sociales', 8000);
...
if (MarketingDigital.vendido == true) {
    carrito.push(MarketingDigital.descuento35())
} else {
    carrito.push({ id: 1, Curso: "Marketing Digital"} )
}
if (RedesSociales.vendido == true) {
    carrito.push(RedesSociales.descuento45())
} else {
    carrito.push({ id: 2, Curso: "Redes Sociales"})
}
if (Programacion.vendido == true) {
    carrito.push(Programacion.descuento50())
} else {
    carrito.push({ id: 3, Curso: "Programacion"})
}

console.log(carrito)

let totalCompra = carrito[1] + carrito[2] + carrito[3];
